...
import bibi.com.newsmvp.pro.presenter.HeathPresenter;

/**
 * A simple {@link Fragment} subclass.
 */
public class FragmentHeathy extends BaseFragment<HeathPresenter> {
    private View view;
    ...
    @Override
    public HeathPresenter bindpresenter() {
        return new HeathPresenter(getContext());
    }

    public FragmentHeathy() {
